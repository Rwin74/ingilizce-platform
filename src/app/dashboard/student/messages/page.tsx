    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-stone-500 mt-1">Eğitmenlerinizle iletişim kurun.</p>
            </div>
                ...
                <CardContent className="p-0">
                    {conversations.length === 0 ? (
                        <div className="text-center py-16">
                            ...
                            <p className="text-xs text-stone-400 mt-1">Bir eğitmenle ders almaya başladığınızda mesajlaşabilirsiniz.</p>
                        </div>
                    ) : (
